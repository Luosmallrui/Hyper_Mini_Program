...
## 页面用途
活动中心筛选面板，支持审核状态、活动状态和时间范围。

## 页面结构
- 推荐路由：`pages/user-sub/organizer/index`
- 内部视图：`activities:filter`
- 当前状态：半完成
- 优先级：P0
- 预览资源：`assets/previews/admin-activity-filter.png`
...
## 与当前代码的差异
当前 filterPanelOpen/filterState 已实现基础多选，但渠道字段和设计稿不完全一致，日期选择联动需验收。
