      ...
      <ScrollView className='content-scroll' scrollY>
        <View className='info-panel' style={{ backgroundImage: `url(${panelBg})` }}>
          ...
          <View className='location-row'>
            ...
            <Image className='location-icon' src='https://lanhu-oss-proxy.lanhuapp.com/SketchPng316000f2c1e243cb13f8f16f4b0e0f5612aad100fd961d8166c868613af34ece' mode='aspectFit' />
          </View>
        ...
        <View className='drawer-mask open' onClick={() => setDrawerOpen(false)}>
          <View className='drawer-panel open' onClick={(e) => e.stopPropagation()}>
            ...
            <View className='drawer-footer'>
              ...
              <View className='pay-btn'>立即支付</View>
            </View>
          </View>
        </View>
      )}
